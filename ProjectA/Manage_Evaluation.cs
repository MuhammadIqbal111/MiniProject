...
namespace ProjectA
{
    public partial class Manage_Evaluation : Form
    {
        ...
        private void Manage_Evaluation_Load(object sender, EventArgs e)
        {
            ...
            this.evaluationTableAdapter.Fill(this.projectADataSet5.Evaluation);
            // TODO: This line of code loads data into the 'projectADataSet5.GroupEvaluation' table. You can move, or remove it, as needed.
           // this.groupEvaluationTableAdapter.Fill(this.projectADataSet5.GroupEvaluation);
