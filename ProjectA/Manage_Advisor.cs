...
namespace ProjectA
{
    public partial class Manage_Advisor : Form
    {
        ...
        private void Manage_Advisor_Load(object sender, EventArgs e)
        {
            ...
            // TODO: This line of code loads data into the 'projectADataSet10.Advisor' table. You can move, or remove it, as needed.
            // this.advisorTableAdapter1.Fill(this.projectADataSet10.Advisor);
